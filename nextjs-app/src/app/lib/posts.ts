export const posts = [
  ...
  },
  {
    ...
    description:
      'Capstone project for the Software Engineering course. A web-based school management system that streamlines administrative tasks, enhances communication, and improves overall efficiency within educational institutions.',
    imageUrl: '/blcsHomepage.png',
    images: [
      '/videos/homepageVid.mp4',
      '/teachersHomepage.png',
      '/MoodleHomepage.png',
      '/profileView.png',
    ],
    descriptions: [
      'The capstone project is a one-year engagement carried out by a team of five, working with a real client seeking a practical, real-world solution. The project follows an Agile methodology and focuses on improving a community language school that aims to transition toward a more online-based learning system for children.  The resulting platform is a comprehensive system that offers features such as student enrolment, attendance tracking, grade management, and scheduling. It serves as a central hub for educational administration, enabling staff to efficiently manage daily operations while maintaining accurate and reliable records.  A range of industry standard tools and technologies were used throughout the project, including Jira for Agile project management, GitHub for version control and collaboration, and GitHub Actions for continuous integration and deployment. The custom portal was developed using Next.js with Tailwind CSS for the frontend, while AWS was utilised for cloud infrastructure and deployment. Moodle was adopted as the primary Learning Management System to support online learning delivery.',
      'Throughout the year, multiple phases were undertaken, including the design and development of a custom school dashboard portal, the adoption of Moodle as the primary Learning Management System, and integration with Zoom to support online classroom interactions. Comprehensive system, code, and testing documentation was produced, and while some features were not implemented due to scope and time constraints, these were clearly documented and identified as potential enhancements for future development.',
      'To support these services, AWS was selected for deployment, providing functionality such as databases, authentication and credential management through Amazon Cognito, logging, and application hosting. As the client is a community organisation with strict financial constraints, hosting decisions were made with cost efficiency in mind. Consequently, a serverless architecture was implemented using AWS Lambda and API Gateway for the custom portal, while MoodleCloud was leveraged for hosting the Moodle platform.',
      'In conclusion, the completion of this unit and capstone project provided valuable real-world experience, while also presenting several challenges that impacted the overall project timeline. Factors such as competing university commitments, evolving client requirements, and a steep learning curve with new technologies contributed to delays and required frequent adjustments to the project plan.  Despite these challenges, the experience offered important insights into effective project and scope management. In retrospect, several improvements were identified, including better strategies to minimise merge conflicts through improved branching practices, greater use of CI/CD pipelines to streamline deployment, and earlier adoption of MoodleCloud rather than attempting to host a custom Moodle instance on AWS. Additionally, deploying earlier in the development cycle, rather than during the final sprint, would have allowed for earlier feedback and reduced deployment risks. Overall, the project strengthened the team’s technical, collaborative, and problem solving skills, while providing a deeper understanding of Agile development in a real client environment. The lessons learned from this experience will directly inform and improve future software development projects.',
    ],
    date: 'Mar 12, 2025',
    datetime: '2025-03-12',

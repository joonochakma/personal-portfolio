export const posts = [
  ...
  },
  {
    ...
    images: [
      'https://joonos-resume.s3.ap-southeast-2.amazonaws.com/homepageVid.mp4',
      '/teachersHomepage.png',
      '/MoodleHomepage.png',
      '/profileView.png',
    ],
    descriptions: [   'A one-year capstone project completed by a team of five for a real client, focused on modernising a community language school through an online learning platform. Developed using Agile methodology, the system provides student enrolment, attendance tracking, grade management, and scheduling as a central administrative hub. Tools and technologies included Jira, GitHub, GitHub Actions, Next.js, Tailwind CSS, AWS, and Moodle.',      'The project progressed through multiple phases, including custom dashboard development, Moodle LMS adoption, and Zoom integration for online classes. Comprehensive system, code, and testing documentation was produced, with unimplemented features documented for future enhancement due to scope constraints.',      'AWS was used for deployment, providing databases, authentication via Amazon Cognito, logging, and hosting. Due to financial constraints, a cost-efficient serverless architecture using AWS Lambda and API Gateway was implemented, while MoodleCloud was used for hosting Moodle.',      'The project presented challenges such as evolving client requirements, competing academic commitments, and a steep learning curve. These experiences highlighted areas for improvement, including better CI/CD usage, improved merge management, earlier deployment, and more effective hosting decisions. Overall, the project strengthened technical, collaboration, and Agile development skills.' ],
    date: 'Mar 12, 2025',
    datetime: '2025-03-12',

      ...
      <main className="flex-1 flex items-center justify-center px-12 sm:px-20 md:px-28 lg:px-40 xl:px-52">
        <AnimatedPost>
          <div className="text-center">
            <h1 className="text-7xl font-Inter font-semibold mb-4">
              Get in Touch
            </h1>
            ...
            <div className="flex items-center justify-center gap-4">
              <span
                ...
                className="animate-fade-up text-lg font-Inter cursor-pointer transition-colors hover:text-transparent hover:bg-gradient-to-r hover:from-purple-500 hover:from-20% hover:via-sky-400 hover:via-30% hover:to-pink-500 hover:to-75% hover:bg-clip-text"
              >
                {email}
              </span>
              <button
